...
public class NfaIntepretor {
    ...
    public NfaIntepretor(Nfa start) {
        this.start = start;
    }
    ...
    public Set<Nfa> move(Set<Nfa> input, char c) {
    	...
    	if (outSet != null&&outSet.size()>0 && debug) {
    ...
    public void intepretNfa(String inputStr) {
    	...
    	if (lastAccepted) {
    		System.err.println("The Nfa Machine can recognize string: " + inputStr);
    	}else {
			System.err.println("The Nfa Machine can't recognize string: " + inputStr);
		}
