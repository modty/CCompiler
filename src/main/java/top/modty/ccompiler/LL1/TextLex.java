...
public class TextLex {
	...
	private String text;
	private ArrayList<Word> lex_result_stack;
	...
	public ArrayList<Word> get_Lex_Result(){
...
//		tbmodel_lex_result.addRow(new String[]{rs_value, rs_name});
		if(rs_name.equals("标识符")){
			lex_result_stack.add(new Word("IDN",rs_value));
		}
		else if(rs_name.equals("整数")){
			lex_result_stack.add(new Word("INT10",rs_value));
		}
		else if (rs_name.equals("科学计数")||rs_name.equals("浮点数")) {
			lex_result_stack.add(new Word("FLOAT",rs_value));
		}
		else if(rs_name.equals("单字符")){
			lex_result_stack.add(new Word("CHAR",rs_value));
		}
		else if(rs_name.equals("字符串")){
			lex_result_stack.add(new Word("STR",rs_value));
		}
		else {
			lex_result_stack.add(new Word(rs_value.toUpperCase(),rs_value));
		}
